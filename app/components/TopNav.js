...
const navItems = [
  ...
  { href: "/admin/faces", label: "Face AI", icon: "🤖" },
      ...
      <header className={`topnav${scrolled ? " topnav-scrolled" : ""}`}>
        <div className="topnav-brand">
          ...
          <div className="brand-title">
            Yolo<span className="brand-title-accent">Home</span>
          </div>
        </div>
        ...
        <div className="topnav-right">
          ...
          <button
            type="button"
            className={`topnav-hamburger ${mobileOpen ? "is-open" : ""}`}
        ...
        <div className="mobile-menu-overlay" onClick={() => setMobileOpen(false)}>
          <nav className="mobile-menu" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="mobile-menu-footer">
              {session?.username && (
                <span className="mobile-menu-user">👤 {session.username}</span>
              )}
              <LogoutButton />
            </div>
          </nav>
